...
enum AST_TYPE {AST_BLOCK, AST_VAR, AST_SET, AST_EXPRESSION, AST_LITERAL, AST_OP, AST_UNOP};
enum OP_TYPE {OP_NONE, OP_ADD, OP_SUB, OP_MUL, OP_DIV, OP_TEST_EQUAL, OP_TEST_GREATER, OP_TEST_GREATER_EQUAL, OP_TEST_LESS, OP_TEST_LESS_EQUAL};
