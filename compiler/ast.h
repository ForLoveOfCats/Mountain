...
enum AST_TYPE {AST_MODULE, AST_BLOCK, AST_IF, AST_ELIF, AST_ELSE, AST_WHILE, AST_BREAK, AST_CONTINUE, AST_FUNC, AST_STRUCT, AST_LET, AST_GET, AST_CALL, AST_RETURN, AST_EXPRESSION, AST_LITERAL, AST_OP, AST_UNOP};
